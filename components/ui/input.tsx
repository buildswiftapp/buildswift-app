...
function Input({ className, type, ...props }: React.ComponentProps<'input'>) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        'h-12 min-h-12 w-full min-w-0 rounded-[6px] border border-[#DEE2E6] bg-[#E9ECEF] px-4 py-2.5 text-sm leading-normal text-[#495057] shadow-none outline-none transition-[color,box-shadow,border-color]',
