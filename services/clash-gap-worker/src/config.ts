...
export const config = {
  ...
  chunkDpi: intEnv('CHUNK_DPI', 400, 72),
  chunkJpegQuality: intEnv('CHUNK_JPEG_QUALITY', 95, 50),
  chunkMaxImageWidth: intEnv('CHUNK_MAX_IMAGE_WIDTH', 6400, 512),
...
export function assertConfig(): void {
  ...
  if (!isDocumentAiConfigured()) {
    throw new Error(
      'Document AI is required. Set DOCUMENT_AI_PROJECT_ID and DOCUMENT_AI_PROCESSOR_ID. ' +
